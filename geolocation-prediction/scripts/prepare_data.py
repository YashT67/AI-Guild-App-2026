...
def prepare_data():
    ...
    # Fast exit if we already did the clustering
    if os.path.exists(output_csv) and os.path.exists(centroids_csv):
        print(f"--> Found {output_csv}. Skipping K-Means generation.")
        return
